...
const PlaylistDeleteWidget = ({ handleDeletePlaylistFormDisplay }) => {
	return (
		<StyledPlaylistDeleteWidget
...
const StyledPlaylistDeleteWidget = styled.div`
	/* display: flex;
...
export default PlaylistDeleteWidget;
