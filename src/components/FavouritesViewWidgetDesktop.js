...
const FavouritesViewWidgetDesktop = ({
	playFavourites,
	shuffleFavourites,
	viewFavourites,
	...
	return (
		<StyledFavouritesViewWidgetDesktop
			...
			<div className='fav-widget-content-wrapper'>
				...
				<div className='fav-widget-icon-wrapper'>
					<ImShuffle
						...
						onClick={handleShuffleFavourites}
					/>
				</div>
				<div className='fav-widget-icon-wrapper'>
...
const StyledFavouritesViewWidgetDesktop = styled.div`
	/* display: flex;
...
export default FavouritesViewWidgetDesktop;
