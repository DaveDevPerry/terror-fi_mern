...
function FavouritesListDesktop({ handleOptions, removeFavourite }) {
	...
	return (
		<StyledFavouritesListDesktop className='favourites-list no_drag'>
		...
		</StyledFavouritesListDesktop>
	);
}
const StyledFavouritesListDesktop = styled.div`
	overflow-y: hidden;
	z-index: 1;
...
export default FavouritesListDesktop;
