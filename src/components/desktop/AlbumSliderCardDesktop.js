...
const AlbumSliderCardDesktop = ({ handleClick, album }) => {
	// const {
	// 	// currentSong,
	// 	// songs,
	// 	// nextSong,
...
const StyledAlbumSliderCardDesktop = styled.div`
	display: flex;
...
export default AlbumSliderCardDesktop;
