...
const RandomizeWidgetDesktop = ({ playAllRandom }) => {
	return (
		<StyledRandomizeWidgetDesktop
...
const StyledRandomizeWidgetDesktop = styled.div`
	/* display: flex;
...
export default RandomizeWidgetDesktop;
