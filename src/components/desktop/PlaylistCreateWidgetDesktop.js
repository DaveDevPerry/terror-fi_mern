...
const PlaylistCreateWidgetDesktop = ({ handlePlaylistFormDisplay }) => {
	return (
		<StyledPlaylistCreateWidgetDesktop
...
const StyledPlaylistCreateWidgetDesktop = styled.div`
	/* display: flex;
...
export default PlaylistCreateWidgetDesktop;
