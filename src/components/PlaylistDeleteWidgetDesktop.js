...
const PlaylistDeleteWidgetDesktop = ({ handleDeletePlaylistFormDisplay }) => {
	return (
		<StyledPlaylistDeleteWidgetDesktop
		...
		>
			...
			<div className='randomize-widget-content-wrapper'>
				...
				<div className='randomize-widget-icon-wrapper'>
					...
					/>
					{/* <FaPlay className='play-randomize-btn' onClick={handleDeletePlaylistFormDisplay} /> */}
				</div>
...
const StyledPlaylistDeleteWidgetDesktop = styled.div`
	/* display: flex;
...
export default PlaylistDeleteWidgetDesktop;
